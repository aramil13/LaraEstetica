    ...
    function getDiagnosisView() {
        ...
        return `
            ...
            <div id="diagnosis-main" style="display: ${hasClient ? 'block' : 'none'};">
                ...
                <iframe src="diagnosis/index.html?v=20260908d" class="diagnosis-iframe" style="width:100%;height:calc(100vh - 240px);border:none;border-radius:12px;background:var(--bg-card);"></iframe>
            </div>
        `;
    }
