...
document.addEventListener('DOMContentLoaded', () => {
     ...
     *  ?? REGLA: para mostrar cualquier fecha en pantalla/impresión usar SIEMPRE esta función.
            ...
            <form id="settings-form">
                ...
                <div style="background:var(--bg-surface);border:1px solid var(--border-color);border-radius:var(--radius-md);padding:1rem;">
                    ...
                    <div class="form-group">
                        ...
                        ${!hasSalons ? '<p style="font-size:0.8rem;color:var(--accent-warning);margin-top:0.35rem;">?? Crea primero un salón en la pestaña Salones.</p>' : (freeSalons.length === 0 ? '<p style="font-size:0.8rem;color:var(--accent-warning);margin-top:0.35rem;">?? Todos tus salones ya tienen su usuario staff.</p>' : '')}
                    </div>
